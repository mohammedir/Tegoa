            ...
            if ($passenger_id){
                if ($passenger_id->email_verified_at != null) {
                    try {
                        ...
                        $transportation_requests->lat_from = doubleval($request->lat_from);
                        $transportation_requests->lng_from = doubleval($request->lng_from);
                        $transportation_requests->lat_to = doubleval($request->lat_to);
                        $transportation_requests->lng_to = doubleval($request->lng_to);
