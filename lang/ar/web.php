...
return [
    ...
    'status' => 'الحالة',
    'Photos' => 'صورة السيارة',
    'Photos_carlicense' => 'صورة رخصة السيارة',
    'Photos_carinsurance' => 'صورة تأمين السيارة',
    ...
    'Photos_cars' => 'صورة السيارة',
    'Photo_carlicense' => 'صورة رخصة سيارة',
    'Photo_carinsurance' => 'صورة تأمين السيارة',
    'creat_car_info' => 'أضف سيارة',
    'driver' => 'السائق',
    'alert' => 'تنبيه',
    'alert1' => 'يجب اضافه سائق اولا ثم يمكنك اضافة سيارة لهذا السائق الجديد.يمكنك اضافه سيارة فقط لسائق لا يملك سيارة مسبقا',
    'Photo_passengersinsurance' => 'صورة تأمين الركاب',
    'verified' => 'التحقق من الايميل',
