...
class CreateTransportationRequestsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('transportation_requests', function (Blueprint $table) {
            ...
            $table->integer('status')->default('1')->comment('1(waiting_driver)/2(accept_driver)/3(start_trip)/4(end_trip)/5(rejected)');
            ...
            $table->longText('complaintPassenger')->nullable();
            $table->longText('complaintDriver')->nullable();
            $table->timestamps();
