$(function () {
    ...
    function update_news() {
        ...
        var KTUsersUpdatePermission = function () {
            const t = document.getElementById("kt_modal_update_emergencies"),
                e = t.querySelector("#kt_modal_update_emergencies_form"), n = new bootstrap.Modal(t);
            return {
                init: function () {
                    (() => {
                        ...
                        i.addEventListener("click", (function (t) {
                            $(".errors").html("");
                            var formData = new FormData(document.getElementById("kt_modal_update_emergencies_form"));
                            ...
                            t.preventDefault(), o && o.validate().then((function (t) {
                                "Valid" == t ? $.ajax({
                                        ...
                                        type: "POST",
                                        url: app_url + "/" + language + "/emergencies/" + $('#emergencies_edit_id').text(),
                                        data: formData,
