$(function () {
    ...
    function create_news() {
        ...
        var KTUsersAddPermission = function () {
            const t = document.getElementById("kt_modal_add_emergency"),
                e = t.querySelector("#kt_modal_add_emergencies_form"),
                ...
                init: function () {
                    (() => {
                        ...
                        i.addEventListener("click", (function (t) {
                            ...
                            $(".errors").html("");
                            var formData = new FormData(document.getElementById("kt_modal_add_emergencies_form"));
                                ...
                                "Valid" == t ? $.ajax({
                                        ...
                                        success: function (response) {
                                            if ($.isEmptyObject(response.error)) {
                                                ...
                                                $('#kt_emergencies_table').DataTable().ajax.reload();
