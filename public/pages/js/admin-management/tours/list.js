...
$(function () {
    ...
    function edit_user(id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#name_en_edit").val(response.tour.full_name['en']);
                $("#name_ar_edit").val(response.tour.full_name['ar']);
                $("#address_en_edit").val(response.tour.address['en']);
                $("#address_ar_edit").val(response.tour.address['ar']);
                $("#gender_edit").val(response.tour.gender);
                $("#email_edit").val(response.tour.email);
                $("#phone_number_edit").val(response.tour.phone_number);
            }
        });
    }
    ...
    function get_forms() {
        var KTAppEcommerceCategories = function () {
            ...
            return {
                init: function () {
                    (t = document.querySelector("#kt_tours_table")) && ((e = $(t).DataTable({
                        searchable: true,
                        ajax: {
