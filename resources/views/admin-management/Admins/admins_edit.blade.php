                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline mb-3"
                                         ...
                                         style="background-image: url({{asset("uploads/admins/".$user->personal_photo)}})">
                                        <!--begin::Preview existing avatar-->
                                        <div id="uploaded_image" data-value="{{$user->personal_photo}}"
                                        ...
                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                            ...
                                            <input id="image_file_input" type="file" name="avatar"
                                                   accept=".png, .jpg, .jpeg" value="{{$user->personal_photo}}"/>
