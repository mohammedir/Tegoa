...
<!--begin::Head-->
<head><base href="../../../"/>
    <title>Tuqu change password</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
    <link rel="shortcut icon" href="{{asset('assets/media/logos/logo_n.jpeg')}}" />
        ...
        <div class="d-flex flex-center w-lg-50 p-10">
            ...
            <div class="card rounded-3 w-md-550px">
                ...
                <div class="card-body p-10 p-lg-20">
                    <!--begin::Form-->
                    <form  method="POST" action="{{ route('password.store') }}" class="form w-100" novalidate="novalidate" id="kt_new_password_form">
                    @csrf
                    <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-8" data-kt-password-meter="true">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="position-relative mb-3">
                                    <input class="form-control bg-transparent" id="password"  type="password" name="password" autocomplete="off" />
